        ...
        <div className="max-w-[1320px] mx-auto px-5 grid lg:grid-cols-2 gap-16 items-center overflow-hidden">
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <a
                href="/resume/3.jfif"
                download="Hemlata-Rani-Resume.pdf"
                className="flex mt-10 px-5 py-3 rounded-full bg-cyan-500 hover:bg-cyan-600 duration-300"
              >
                Download Resume
                <VscDownload className="ml-2 mt-1 text-xl" />
              </a>
            </div>
          </div>
